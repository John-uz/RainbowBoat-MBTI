    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
        <div className="w-full max-w-3xl bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
            ...
            <div className="p-8 overflow-y-auto custom-scrollbar prose dark:prose-invert max-w-none text-slate-700 dark:text-slate-300">
                <h3>⚓ 欢迎船长</h3>
                <p>作为《彩虹船》的现场引导者（船长），你的任务是利用大屏幕投屏，带领现场玩家进行一次深入心灵的社交冒险。</p>
                
                <h4>🕹️ 硬件与环境准备</h4>
                <ul>
                    <li><strong>投屏设备</strong>：建议使用电视或投影仪，连接一台电脑作为控制端。</li>
                    <li><strong>声音</strong>：开启设备声音，游戏包含背景音效和语音播报。</li>
                    <li><strong>空间</strong>：让玩家围坐在屏幕前，确保每个人都能看清屏幕和彼此。</li>
                </ul>

                <h4>🧠 AI 配置 (关键!)</h4>
                <p>本游戏依赖 AI 生成实时任务和深度报告。请点击右上角的 <strong>设置图标</strong> 进行配置：</p>
                <ul>
                    <li><strong>推荐方案</strong>：使用 Google Gemini API (免费且速度快)。</li>
                    <li><strong>备用方案</strong>：如果不配置，系统将尝试使用 Pollinations (不稳定) 或离线题库。</li>
                    <li><strong>隐私安全</strong>：Key 仅保存在浏览器本地，不会上传服务器。</li>
                </ul>

                <h4>🎤 引导技巧</h4>
                <ul>
                    <li><strong>破冰</strong>：在“玩家配置”环节，鼓励大家用真实的自拍照作为头像，增加代入感。</li>
                    <li><strong>任务环节</strong>：当 AI 生成任务时，请大声朗读或让玩家朗读任务内容。</li>
                    <li><strong>互评环节</strong>：这是游戏的高光时刻。引导大家不要吝啬赞美，给出真诚的评价。</li>
                    <li><strong>赛博珍藏</strong>：游戏结束后，记得点击“赛博珍藏”下载本次航行的独家纪念 HTML。</li>
                </ul>
            </div>
