...
## ⚠️ 最佳体验指南 (硬件提示)
**为了让 AI 船长能看清你的神态、听懂你的表达，从而发挥 100% 的分析能力，请注意：**
- 📱 **设备推荐**：使用 **手机或平板** 体验最佳，方便在做任务时展示肢体语言。
- 🎙️ **麦克风**：请授予网页麦克风权限，以便我们记录你的高能呐喊和走心对谈。
- 📷 **摄像头**：请授予摄像头权限。我们不会保存视频流，只会截取关键帧（Keyframes）给 AI 进行神态分析。
...
*   **上下文注入策略**：我们不将复杂的历史记录直接丢给 LLM，而是通过中间层将游戏行为转化为**行为向量 (Behavioral Stats)**，如“风险偏好系数”、“社交依赖拓扑”等，让 AI 能在有限 Token 内洞察玩家的深层心理机制。
